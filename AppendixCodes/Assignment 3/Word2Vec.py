...
if __name__ == '__main__':
    ...
    # for weight_mode in ['nonweighted','tfidfweighted']:
    weight_mode = 'nonweighted'
    ...
    learner = SVC(probability=True,kernel='rbf')
    TrainProcess(record_mode_key,'SVM',learner,train_vec,y_train,val_vec,y_val)
